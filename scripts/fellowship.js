...
const makeHobbits = () => {
  ...
  // hint: get 'The-Shire' by using its id (# is used for ID before the name)
  $("#The-Shire").append($ul)
...
// ============
const makeBaddies = () => {
console.log("Danger commeth")
  // 1. display an unordered list of baddies in Mordor
  const $ul = $("<ul>")
  
  for (baddie of baddies) {
    const $li = $("<li>").text(baddie)
      $li.addClass("baddy")
      $ul.append($li)
  ...
  // 2. give each of the baddies a class of "baddy"
   ...
   //This was done in the previous question
...
// ============
const makeBuddies = () => {
console.log("Fine, Keep your secrets")
...
const beautifulStranger = () => {
 console.log("Here is the sword that was broken and is forged again")
...
console.log("Gondor calls to aid!")
  ...
  const $baddies = $(".baddy")
  $baddies.eq(2).remove() // <--- Google helped me find this guy
...
const itsDangerousToGoAlone = () => {
 console.log("They're taking the hobits to Isengard")
  // 1. take Frodo and Sam out of the fellowship and move them to Mordor (they don't need to be inside a ul in Mordor)
  const $hobbits = $(".hobbit")
  $("#Mordor").append($hobbits.eq(0))
  $("#Mordor").append($hobbits.eq(1))
  

  // 2. add a div with an id of 'mount-doom' to Mordor
   const $div = $("<div>").attr("id", "mount-doom").append("#Mordo")
